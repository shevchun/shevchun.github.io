...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('.main-info__brands-item-more').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0__(this).toggleClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0__(this).parents('.main-info__brands-item-inner').siblings('.main-info__brands-item-more-text').slideToggle();
  });
  function isFloat(value) {
    return typeof value === 'number' && !Number.isNaN(value) && !Number.isInteger(value);
  }
  jquery__WEBPACK_IMPORTED_MODULE_0__('[data-rate]').each(function (index, element) {
    var val = jquery__WEBPACK_IMPORTED_MODULE_0__(element).attr('data-rate');
    if (!isFloat(val)) {
      val = parseFloat(val).toFixed(1);
    }
    var full = val.split('.')[0] || null;
    var fraction = val.split('.')[1] || null;
    jquery__WEBPACK_IMPORTED_MODULE_0__(element).find(jquery__WEBPACK_IMPORTED_MODULE_0__('.rate__item-holder-inner')).each(function (i, item) {
      if (i <= +full) {
        jquery__WEBPACK_IMPORTED_MODULE_0__(item).addClass('active');
      }
      if (i === +full) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('.js-comment').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.popup-comment').addClass('active');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__('.js-close-comment').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.popup-comment').removeClass('active');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__('.js-textarea-counter').on('input', function () {
    var charCount = jquery__WEBPACK_IMPORTED_MODULE_0__(this).val().length;
    jquery__WEBPACK_IMPORTED_MODULE_0__('.popup-comment__counter-current').text(charCount);
  });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('.upgrades__item input').on('change', function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0__(this).is(":checked")) {
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).closest('.upgrades__item').addClass('active');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).closest('.upgrades__item').removeClass('active');
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__('.selec-input input').on('change', function () {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.init-select2').each(function (index, element) {
    jquery__WEBPACK_IMPORTED_MODULE_0__(element).select2({
      ...
      dropdownParent: jquery__WEBPACK_IMPORTED_MODULE_0__(element).parents('.js-parent-select'),
      placeholder: jquery__WEBPACK_IMPORTED_MODULE_0__(element).parents('.js-parent-select').attr('data-placeholder')
    });
  });
});
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('.main-info__archive-slider').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.main-info__archive-slider').slick({
      slidesToShow: 1,
      dots: true,
      prevArrow: '<span class="slick-prev"><svg width="19" height="36" viewBox="0 0 19 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 1L1 18L18 35" stroke="#01231F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg></span>',
      nextArrow: '<span class="slick-next"><svg width="19" height="36" viewBox="0 0 19 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 1L1 18L18 35" stroke="#01231F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg></span>'
    });
  }
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('.main-info__testimonials-slider').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.main-info__testimonials-slider').slick({
      slidesToShow: 1,
      dots: true,
      fade: true,
      adaptiveHeight: true,
      prevArrow: '<span class="slick-prev"><svg width="11" height="18" viewBox="0 0 11 18" xmlns="http://www.w3.org/2000/svg"><path d="M0.703128 8.20312L8.20313 0.703123C8.41447 0.491777 8.70112 0.373047 9 0.373047C9.29889 0.373047 9.58553 0.491777 9.79688 0.703123C10.0082 0.914467 10.127 1.20111 10.127 1.5C10.127 1.79888 10.0082 2.08553 9.79688 2.29687L3.09282 8.99906L9.795 15.7031C9.89965 15.8078 9.98266 15.932 10.0393 16.0687C10.0959 16.2055 10.1251 16.352 10.1251 16.5C10.1251 16.648 10.0959 16.7945 10.0393 16.9313C9.98266 17.068 9.89965 17.1922 9.795 17.2969C9.69035 17.4015 9.56612 17.4845 9.42939 17.5412C9.29266 17.5978 9.14612 17.627 8.99813 17.627C8.85013 17.627 8.70359 17.5978 8.56686 17.5412C8.43013 17.4845 8.3059 17.4015 8.20125 17.2969L0.701254 9.79687C0.596496 9.69223 0.513426 9.56794 0.456805 9.43113C0.400184 9.29432 0.371129 9.14767 0.371303 8.99961C0.371478 8.85154 0.400879 8.70497 0.457821 8.56829C0.514763 8.43161 0.598124 8.30752 0.703128 8.20312Z" /></svg></span>',
      nextArrow: '<span class="slick-next"><svg width="11" height="18" viewBox="0 0 11 18" xmlns="http://www.w3.org/2000/svg"><path d="M0.703128 8.20312L8.20313 0.703123C8.41447 0.491777 8.70112 0.373047 9 0.373047C9.29889 0.373047 9.58553 0.491777 9.79688 0.703123C10.0082 0.914467 10.127 1.20111 10.127 1.5C10.127 1.79888 10.0082 2.08553 9.79688 2.29687L3.09282 8.99906L9.795 15.7031C9.89965 15.8078 9.98266 15.932 10.0393 16.0687C10.0959 16.2055 10.1251 16.352 10.1251 16.5C10.1251 16.648 10.0959 16.7945 10.0393 16.9313C9.98266 17.068 9.89965 17.1922 9.795 17.2969C9.69035 17.4015 9.56612 17.4845 9.42939 17.5412C9.29266 17.5978 9.14612 17.627 8.99813 17.627C8.85013 17.627 8.70359 17.5978 8.56686 17.5412C8.43013 17.4845 8.3059 17.4015 8.20125 17.2969L0.701254 9.79687C0.596496 9.69223 0.513426 9.56794 0.456805 9.43113C0.400184 9.29432 0.371129 9.14767 0.371303 8.99961C0.371478 8.85154 0.400879 8.70497 0.457821 8.56829C0.514763 8.43161 0.598124 8.30752 0.703128 8.20312Z" /></svg></span>'
    });
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (["dev", "Order-summary.html", "Saya-Upgrades.html", "Sword-Brand.html", "Swordis-Portfolio-Individual.html", "Swordis-Portfolio.html", "index.html", "step-1.html", "step-10.html", "step-2.html", "step-3.html", "step-4.html", "step-5.html", "step-6.html", "step-7.html", "step-8.html", "step-9.html"]);
...
/* harmony import */ var _components_sliders_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/sliders.js */ "./app/scripts/components/sliders.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_components_sliders_js__WEBPACK_IMPORTED_MODULE_6__["default"])();
