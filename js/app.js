...
(0, _jquery2.default)(window).on('load resize', function () {
  if ((0, _jquery2.default)(window).width() < 1200) {
    ...
    (0, _jquery2.default)('.post__author').append((0, _jquery2.default)('.post__author-text'));
  } else {
    (0, _jquery2.default)('.header__center').append((0, _jquery2.default)('.header__nav'));
    (0, _jquery2.default)('.post__author-text').insertAfter((0, _jquery2.default)('.post__author-head'));
  }
});
...
exports.default = ["dev", "404.html", "blog-post.html", "category.html", "contacts.html", "editorial.html", "index.html"];
...
exports.default = function () {
  ...
  (0, _jquery2.default)('.js-btn-down').on("click", function scrollToSectionFunc() {
    ...
    if ((0, _jquery2.default)(scrollEl).length !== 0) {
      (0, _jquery2.default)('html, body').animate({
        scrollTop: (0, _jquery2.default)(scrollEl).offset().top - 84
      }, 500);
    }
    return false;
  });

  (0, _jquery2.default)('.menu-item-has-children > a').on('click', function openDropDown() {
    if ((0, _jquery2.default)(window).width() < 1200) {
      (0, _jquery2.default)(this).parent('li').toggleClass('active');
      return false;
    }return null;
  });

  (0, _jquery2.default)('.header__menu-btn').on('click', function () {
    (0, _jquery2.default)('.header__mobile').addClass('active');
  });

  (0, _jquery2.default)('.js-close-mobile').on('click', function () {
  ...
  (0, _jquery2.default)('.text-content table').wrap('<div class="table-scroll"></div>');

  if ((0, _jquery2.default)('.js-sticky-btn').length) {
    (0, _jquery2.default)('.wrapper').addClass('wrapper--overflow-inherit');
  }

  (0, _jquery2.default)('.js-close-popup').on('click', function () {
    (0, _jquery2.default)('.js-popup').removeClass('active');
  });
};
...
exports.default = function () {
  (0, _jquery2.default)('.init-select2').each(function (index, element) {
    ...
    (0, _jquery2.default)(element).select2({
      ...
      dropdownParent: (0, _jquery2.default)(element).parents('.select2-parent')
    });
  });
};
