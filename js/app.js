...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var searchButton = document.querySelector('.search__mobile-btn');
  var menuButton = document.querySelector('.js-open-menu');
  var body = document.body;
  var headerMobile = document.querySelector('.header__mobile');
  var search = document.querySelector('.search');
  if (!searchButton || !menuButton || !headerMobile) return;
  searchButton.addEventListener('click', function () {
    var search = this.closest('.search');
    if (!search) return;
    if (body.classList.contains('ovh') && !search.classList.contains('active-mobile')) {
      search.classList.add('active-mobile');
    } else {
      search.classList.toggle('active-mobile');
      body.classList.toggle('ovh');
    }
    menuButton.classList.remove('active');
    headerMobile.classList.remove('active');
  });
  if (!menuButton || !headerMobile || !search) return;
  menuButton.addEventListener('click', function () {
    var isActive = body.classList.contains('ovh') && !menuButton.classList.contains('active') && !headerMobile.classList.contains('active');
    if (isActive) {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() < 1200) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.menu-item-has-children > a').on('click', function mobileNav(event) {
      ...
      if (parents === 2) {
        jquery__WEBPACK_IMPORTED_MODULE_0__(this).parents('.menu-item-has-children').parents('.menu-item-has-children').addClass('level');
      }
      if (!parent.hasClass('active')) {
        event.preventDefault();
        parent.addClass('active');
        parent.siblings('li').css('display', 'none');
        if (!jquery__WEBPACK_IMPORTED_MODULE_0__(this).find('.back-level-btn').length) {
          jquery__WEBPACK_IMPORTED_MODULE_0__(this).prepend('<span class="back-level-btn"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.3661 13.6127L6.01939 9.26607C5.50606 8.75273 5.50606 7.91274 6.01939 7.3994L10.3661 3.05273" stroke="black" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/></svg></span>');
        }
      }
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '.back-level-btn', function mobileNavBack(event) {
      event.preventDefault();
      var parent = jquery__WEBPACK_IMPORTED_MODULE_0__(this).closest('.menu-item-has-children');
      jquery__WEBPACK_IMPORTED_MODULE_0__('.menu-item-has-children').removeClass('level');
      parent.removeClass('active');
      parent.siblings('li').css('display', 'block');
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  function formatOption(option) {
    ...
    return jquery__WEBPACK_IMPORTED_MODULE_0__("<span class='select-option'>".concat(option.text, " <span class='select-option-price'>").concat(price, "</span></span>"));
  }
  ...
  {/* <div class="select-parent js-parent-select" data-placeholder="Sort by">
   <select class="init-select2" style="width: 100%">
    <option></option>
    <option value="lenghty text to display">lenghty text to display</option>
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_1__('.product__thumbnails-slider') && jquery__WEBPACK_IMPORTED_MODULE_1__('.product__main-slider')) {
    var navSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.product__thumbnails-slider', {
      ...
      navigation: {
        nextEl: ".product__sliders-button--next",
        prevEl: ".product__sliders-button--prev"
      }
    });
    ...
    var mainSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.product__main-slider', {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Pagination],
      thumbs: {
        swiper: jquery__WEBPACK_IMPORTED_MODULE_1__(window).width() > 1200 ? navSlider : null
      },
      navigation: {
        nextEl: ".product__sliders-button--next",
        prevEl: ".product__sliders-button--prev"
      ...
      pagination: {
        el: ".product__main-slider-pagination"
      }
    });
    var productGallery = new photoswipe_lightbox__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  var swiperInstances = [];
  var initSwiper = function initSwiper(element) {
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](element, {
  ...
  var checkWindowSize = function checkWindowSize() {
    var sliders = document.querySelectorAll('.js-thumbs-slider');
    if (window.matchMedia('(max-width: 1200px)').matches) {
      sliders.forEach(function (slider) {
        if (!swiperInstances.some(function (swiper) {
          return swiper.el === slider;
        })) {
          initSwiper(slider);
        }
      });
...
/* harmony import */ var _components_tabs_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/tabs.js */ "./app/scripts/components/tabs.js");
...
document.addEventListener('DOMContentLoaded', function () {
  globalThis.Tabs = new _components_tabs_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
...
jquery__WEBPACK_IMPORTED_MODULE_1__(window).on('load resize', function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_1__(window).width() < 1200) {
    ...
    requestAnimationFrame(function () {
      var height = getElementHeight('.header');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.header__mobile, .search__form-holder').css('height', "calc(100dvh - ".concat(height, "px)"));
    });
    jquery__WEBPACK_IMPORTED_MODULE_1__('.header__logo').insertAfter('.header__left');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1__('.header__bottom > .container').append(jquery__WEBPACK_IMPORTED_MODULE_1__('.header__nav'));
    if (jquery__WEBPACK_IMPORTED_MODULE_1__('.product__title-box').length) {
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "front-end-developer-kit:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfront_end_developer_kit"] = self["webpackChunkfront_end_developer_kit"] || [];
