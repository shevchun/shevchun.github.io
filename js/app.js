...
exports.default = function () {
  ...
  if ((0, _jquery2.default)('.bottle-tabs__holder').length) {
    ...
    (0, _jquery2.default)('.bottle-tabs__list a').on('click', function clickDownScroll() {
  ...
  if (window.innerWidth < 768) {
    (0, _jquery2.default)('.brands__item-text-more').on('click', function () {
      (0, _jquery2.default)(this).parents('.brands__item').toggleClass('active');
    });
  }
