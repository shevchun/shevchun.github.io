...
var _custom = __webpack_require__(27);
...
document.addEventListener("DOMContentLoaded", function () {
  if ((0, _jquery2.default)(window).width() > 1200) {
    (0, _jquery2.default)(".js-sticky").stick_in_parent({
      offset_top: 10
    });
  }
...
var _odnoklassniki = __webpack_require__(20);
...
var _plusone = __webpack_require__(22);
...
var _vkontakte = __webpack_require__(24);
...
var _telegram = __webpack_require__(25);
...
var _linkedin = __webpack_require__(26);
...
exports.default = function () {
  ...
  (0, _jquery2.default)('.recommended__drop-current').on('click', function customSelect(event) {
    event.stopPropagation();
    (0, _jquery2.default)(this).parents('.recommended__drop').toggleClass('active');
  });
  (0, _jquery2.default)('.recommended__drop-item').on('click', function customSelectChoice(event) {
    event.stopPropagation();
    var innerInfo = (0, _jquery2.default)(this).html();
  ...
  _ui.Fancybox.defaults.Hash = false;
  ...
  (0, _jquery2.default)('.js-btn-down').on('click', function clickDownScroll() {
    ...
    if ((0, _jquery2.default)(scrollEl).length !== 0) {
      (0, _jquery2.default)('html, body').animate({
        scrollTop: (0, _jquery2.default)(scrollEl).offset().top - marginTop
      }, 500);
    }
    return false;
  });

  (0, _jquery2.default)('.faq__head').on('click', function faqToggle() {
    if (!(0, _jquery2.default)(this).parents('.faq__item').hasClass('active')) {
      (0, _jquery2.default)('.faq__item').removeClass('active');
    }
    (0, _jquery2.default)(this).parents('.faq__item').toggleClass('active');
  });

  if ((0, _jquery2.default)('.sources__head-btn').length) {
    (0, _jquery2.default)('.sources__head-btn').on('click', function sourceFunc() {
      (0, _jquery2.default)(this).parents('.sources').toggleClass('active');
      (0, _jquery2.default)(this).parents('.sources').find('.sources__body').slideToggle();
    });
  }

  if ((0, _jquery2.default)('.blog-product__mobile-btn').length) {
    (0, _jquery2.default)('.blog-product__mobile-btn').on('click', function blogFunc() {
      (0, _jquery2.default)(this).siblings('.blog-product__text').toggleClass('active');
  ...
  if ((0, _jquery2.default)('.js-nav').length) {
    ...
    if ((0, _jquery2.default)(window).width() > 1200) {
      (0, _jquery2.default)(window).on('scroll', function scrollWind() {
        var fromTop = (0, _jquery2.default)(this).scrollTop() + _topMenuHeight;
        var cur = _scrollItems.map(function curFunc() {
          if ((0, _jquery2.default)(this).offset().top < fromTop) return this;
        });
        cur = cur[cur.length - 1];
        var id = cur && cur.length ? cur[0].id : '';
    ...
    (0, _jquery2.default)('.js-nav a').on('click', function ancordsLinks(e) {
      var id = (0, _jquery2.default)(this).attr('href');
      e.preventDefault();
      var top = (0, _jquery2.default)(id).offset().top - 10;
      (0, _jquery2.default)('.js-nav li').removeClass('active');
      (0, _jquery2.default)(this).parent().addClass('active');
      (0, _jquery2.default)('body,html').animate({ scrollTop: top }, 1000);
    });

    (0, _jquery2.default)('.js-nav li').mouseover(function navFunc() {
      var activeItem = (0, _jquery2.default)('.js-nav li.active').index();
      var curentItem = (0, _jquery2.default)(this).index();
      if (curentItem < activeItem) {
        (0, _jquery2.default)(this).addClass('svg-top');
      } else {
        (0, _jquery2.default)(this).removeClass('svg-top');
      }
    });
    (0, _jquery2.default)('.js-nav li').mouseleave(function () {
      (0, _jquery2.default)('.js-nav li').removeClass('svg-top');
    });
  }

  if ((0, _jquery2.default)('.js-blog').length) {
    (0, _jquery2.default)('.header').addClass('no-shadow');
  }

  (0, _jquery2.default)('.review2__item-btn').on('click', function reviewBtn() {
    (0, _jquery2.default)(this).parents('.review2__item').toggleClass('active');
  });

  (0, _jquery2.default)('.star-rating__item').on('click', function rateClick() {
    var parent = (0, _jquery2.default)(this).parent('.star-rating');
    var rating = (0, _jquery2.default)(this).data('value');
    var valueHolder = parent.find('.star-rating__value');

    if (!parent.hasClass('disabled')) {
      (0, _jquery2.default)(this).addClass('active');
      (0, _jquery2.default)(this).prevAll('.star-rating__item').addClass('active');
  ...
  (0, _jquery2.default)(window).on('load resize', function () {
    if ((0, _jquery2.default)(window).width() < 767) {
      ...
      (0, _jquery2.default)('.blog-product').each(function (index, element) {
        ...
        (0, _jquery2.default)(element).find('.blog-product__btn-box:not(.blog-product__btn-box--no-js)').insertBefore((0, _jquery2.default)(element).find('.blog-product__body'));
      });
      (0, _jquery2.default)('.cart__item').each(function (index, element) {
        (0, _jquery2.default)(element).find('.cart__item-cell').append((0, _jquery2.default)(element).find('.cart__item-count'));
      });
      if ((0, _jquery2.default)('.product-page__controls').length) {
        (0, _jquery2.default)('body').addClass('pb');
      }
      if ((0, _jquery2.default)('.checkout__pay-btn-box').length) {
      ...
      (0, _jquery2.default)('.blog-product').each(function (index, element) {
        (0, _jquery2.default)(element).find('.blog-product__title').insertBefore((0, _jquery2.default)(element).find('.blog-product__head-text'));
        (0, _jquery2.default)(element).find('.blog-product__btn-box:not(.blog-product__btn-box--no-js)').insertAfter((0, _jquery2.default)(element).find('.blog-product__body'));
      });
      (0, _jquery2.default)('.cart__item').each(function (index, element) {
        (0, _jquery2.default)(element).find('.cart__item-count').insertAfter((0, _jquery2.default)(element).find('.cart__item-cell'));
      });
      if ((0, _jquery2.default)('.product-page__controls').length) {
        (0, _jquery2.default)('body').removeClass('pb');
      }
      if ((0, _jquery2.default)('.checkout__pay-btn-box').length) {
        (0, _jquery2.default)('body').removeClass('pb2');
      }
    }
    if ((0, _jquery2.default)(window).width() < 1200) {
      (0, _jquery2.default)('.breadcrumb-mobile-box').append((0, _jquery2.default)('.js-breadcrumb'));
      (0, _jquery2.default)('.product-page__title').insertBefore((0, _jquery2.default)('.product-page__mobile-row'));
      (0, _jquery2.default)('.product-page__mobile-row').append((0, _jquery2.default)('.product-page__price:not(.product-page__price--new)'));
      (0, _jquery2.default)('.product-page__price').append((0, _jquery2.default)('.js-product-rate:not(.js-product-rate-new)'));
      ...
      (0, _jquery2.default)('.js-product-rate:not(.js-product-rate-new)').insertBefore((0, _jquery2.default)('.product-page__info-rate .rate-counter:not(.rate-counter--reviews )'));
      (0, _jquery2.default)('.buy-with').insertAfter((0, _jquery2.default)('.product-page__nav-new'));
      (0, _jquery2.default)('.product-page__info-head').append((0, _jquery2.default)('.js-breadcrumb'));
      (0, _jquery2.default)('.product-page__info-head').append((0, _jquery2.default)('.product-page__info-rate--new'));
      (0, _jquery2.default)('.product-page__descriptions--new').insertAfter((0, _jquery2.default)('.product-page__title'));
      (0, _jquery2.default)('.buy-with__bottom-row').append((0, _jquery2.default)('.buy-with__btn'));
    }
  });

  if ((0, _jquery2.default)(window).width() < 1200) {
    if ((0, _jquery2.default)('.shop__text-btn').length) {
      (0, _jquery2.default)('.shop__text-btn').on('click', function () {
        (0, _jquery2.default)('.shop__text').toggleClass('active');
      });
    }
    (0, _jquery2.default)('.js-mobile-filter').on('click', function () {
      (0, _jquery2.default)('.shop__filter').addClass('active');
      setTimeout(function () {
        (0, _jquery2.default)('.shop__filter-box').addClass('active');
      }, 300);
    });
    (0, _jquery2.default)('.js-close-filter').on('click', function () {
      (0, _jquery2.default)('.shop__filter-box').removeClass('active');
      setTimeout(function () {
        (0, _jquery2.default)('.shop__filter').removeClass('active');
      }, 300);
    });
    (0, _jquery2.default)('.js-mobile-btn').on('click', function () {
      (0, _jquery2.default)('.header__middle').addClass('active');
      setTimeout(function () {
        (0, _jquery2.default)('.header__middle-box').addClass('active');
      }, 300);
    });
    (0, _jquery2.default)('.js-close-mobile-menu').on('click', function () {
      (0, _jquery2.default)('.header__middle-box').removeClass('active');
      setTimeout(function () {
        (0, _jquery2.default)('.header__middle').removeClass('active');
      }, 300);
    });
  }

  (0, _jquery2.default)('.js-top-scroll').on('click', function () {
    (0, _jquery2.default)('body,html').animate({
      scrollTop: 0
    }, 1000);
  });

  (0, _jquery2.default)('.header__basket').on('click', function (event) {
    event.stopPropagation();
    (0, _jquery2.default)('.header__popup').toggleClass('active');
  });

  (0, _jquery2.default)('.header__popup-close').on('click', function (event) {
    event.stopPropagation();
...
var _nouislider = __webpack_require__(31);
...
exports.default = function () {
  if ((0, _jquery2.default)('#filter-slider').length) {
    var slider = document.getElementById('filter-slider');
    var inputDecrement = document.getElementById('filter-decrement');
    var inputIncrement = document.getElementById('filter-increment');
    _nouislider2.default.create(slider, {
      start: startValueRange,
      connect: true,
      range: {
        'min': minRange,
        'max': maxRange
    ...
    slider.noUiSlider.on('update', function (values, handle) {
      ...
      if (handle) {
        inputIncrement.value = value.split('.')[0];
      } else {
        inputDecrement.value = value.split('.')[0];
      }
    });
    inputIncrement.addEventListener('change', function incFunc() {
      slider.noUiSlider.set([null, this.value]);
    });
    inputDecrement.addEventListener('change', function decFunc() {
      slider.noUiSlider.set([this.value, null]);
    });
  }

  (0, _jquery2.default)('.featured-products__slider').slick({
    slidesToShow: 4,
    slidesToScroll: 1,
    prevArrow: '<span class="slick-prev"><svg width="42" height="82" viewBox="0 0 42 82" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M40.0829 0.292877C40.4735 -0.0976487 41.1066 -0.0976487 41.4971 0.292877C41.8877 0.683395 41.8877 1.31656 41.4971 1.70709L2.38789 40.8164L41.4967 79.9252C41.8873 80.3157 41.8873 80.9489 41.4967 81.3394C41.1062 81.73 40.4731 81.73 40.0825 81.3394L0.291918 41.5488C0.0881747 41.3451 -0.00927557 41.0753 -0.000425462 40.8084C-0.00504505 40.5465 0.0925349 40.2833 0.292311 40.0835L40.0829 0.292877Z"/></svg></span>',
    nextArrow: '<span class="slick-next"><svg width="42" height="82" viewBox="0 0 42 82" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M40.0829 0.292877C40.4735 -0.0976487 41.1066 -0.0976487 41.4971 0.292877C41.8877 0.683395 41.8877 1.31656 41.4971 1.70709L2.38789 40.8164L41.4967 79.9252C41.8873 80.3157 41.8873 80.9489 41.4967 81.3394C41.1062 81.73 40.4731 81.73 40.0825 81.3394L0.291918 41.5488C0.0881747 41.3451 -0.00927557 41.0753 -0.000425462 40.8084C-0.00504505 40.5465 0.0925349 40.2833 0.292311 40.0835L40.0829 0.292877Z"/></svg></span>',
    responsive: [{
      breakpoint: 1320,
      settings: {
        arrows: false,
  ...
  if ((0, _jquery2.default)('.about__products-img-slider').length) {
    (0, _jquery2.default)('.about__products-img-slider').slick({
      slidesToShow: 1,
      slidesToScroll: 1,
      arrows: false,
      dots: true,
  ...
  (0, _jquery2.default)('.product-page__for').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
    fade: true,
  ...
  (0, _jquery2.default)('.product-page__nav').slick({
    slidesToShow: 4,
    slidesToScroll: 1,
    asNavFor: '.product-page__for',
    focusOnSelect: true,
    vertical: true,
    prevArrow: '<span class="slick-prev"><svg width="10" height="7" viewBox="0 0 10 7" xmlns="http://www.w3.org/2000/svg"><path d="M1 6L5 2L9 6" stroke-width="2"/></svg></span>',
    nextArrow: '<span class="slick-next"><svg width="10" height="7" viewBox="0 0 10 7" xmlns="http://www.w3.org/2000/svg"><path d="M1 6L5 2L9 6" stroke-width="2"/></svg></span>'
  });

  (0, _jquery2.default)('.product-page__for-new').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
    fade: true,
    infinite: false,
    asNavFor: '.product-page__nav-new',
    responsive: [{
      breakpoint: 1200,
      settings: {
        arrows: false
  ...
  (0, _jquery2.default)('.product-page__nav-new').slick({
    slidesToShow: 5,
    slidesToScroll: 1,
    asNavFor: '.product-page__for-new',
    swipeToSlide: true,
    infinite: false,
    focusOnSelect: true,
    prevArrow: '<span class="slick-prev"><svg width="10" height="7" viewBox="0 0 10 7" xmlns="http://www.w3.org/2000/svg"><path d="M1 6L5 2L9 6" stroke-width="2"/></svg></span>',
  ...
  (0, _jquery2.default)('.stories__slider').slick({
    slidesToShow: 3,
    slidesToScroll: 1,
    swipeToSlide: true,
    prevArrow: '<span class="slick-prev"><svg width="42" height="82" viewBox="0 0 42 82" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M40.0839 0.292877C40.4744 -0.0976487 41.1076 -0.0976486 41.4981 0.292877C41.8887 0.683395 41.8887 1.31656 41.4981 1.70709L2.38886 40.8164L41.4977 79.9252C41.8882 80.3157 41.8882 80.9489 41.4977 81.3394C41.1072 81.73 40.474 81.73 40.0835 81.3394L0.292894 41.5488C0.0891512 41.3451 -0.00829901 41.0753 0.000551101 40.8084C-0.00406849 40.5465 0.0935115 40.2833 0.293287 40.0835L40.0839 0.292877Z"/></svg></span>',
    nextArrow: '<span class="slick-next"><svg width="42" height="82" viewBox="0 0 42 82" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M40.0839 0.292877C40.4744 -0.0976487 41.1076 -0.0976486 41.4981 0.292877C41.8887 0.683395 41.8887 1.31656 41.4981 1.70709L2.38886 40.8164L41.4977 79.9252C41.8882 80.3157 41.8882 80.9489 41.4977 81.3394C41.1072 81.73 40.474 81.73 40.0835 81.3394L0.292894 41.5488C0.0891512 41.3451 -0.00829901 41.0753 0.000551101 40.8084C-0.00406849 40.5465 0.0935115 40.2833 0.293287 40.0835L40.0839 0.292877Z"/></svg></span>',
    responsive: [{
      breakpoint: 1200,
      settings: {
        slidesToShow: 2,
        prevArrow: '<span class="slick-prev"><svg width="12" height="24" viewBox="0 0 12 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.9219 1.49998C11.9215 1.89767 11.7633 2.27895 11.4819 2.55998L3.80988 10.232C3.57766 10.4641 3.39345 10.7398 3.26777 11.0431C3.1421 11.3465 3.07741 11.6716 3.07741 12C3.07741 12.3283 3.1421 12.6535 3.26777 12.9568C3.39345 13.2602 3.57766 13.5358 3.80988 13.768L11.4719 21.435C11.7451 21.7179 11.8963 22.0968 11.8929 22.4901C11.8895 22.8834 11.7317 23.2596 11.4536 23.5377C11.1755 23.8158 10.7993 23.9736 10.406 23.977C10.0127 23.9804 9.63378 23.8292 9.35088 23.556L1.68888 15.895C0.658642 14.8627 0.0800333 13.4639 0.0800334 12.0055C0.0800335 10.5471 0.658642 9.14824 1.68888 8.11598L9.36088 0.443983C9.57036 0.234365 9.83723 0.0914953 10.1278 0.0334013C10.4184 -0.0246927 10.7197 0.00459088 10.9937 0.117559C11.2677 0.230528 11.502 0.422117 11.6672 0.668152C11.8324 0.914186 11.921 1.20364 11.9219 1.49998Z"/></svg></span>',
