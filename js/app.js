...
(0, _jquery2.default)(window).on('load', function () {
  ...
  //   const prevNav = $('.personal-area__nav-item.active').prevAll();
  //   let totalSum = 0;
  //   for (var i = 0; i < prevNav.length; i++) {
  //     totalSum += Number(prevNav[i].clientWidth);
  //   }
  //   $(".personal-area__nav").scrollLeft(totalSum);
  // }
});
...
exports.default = ["dev", "2-warehouse-racks-category.html", "3-pallet-racking-systems.html", "4-structural-pallet-racking.html", "5-push-back-pallet-racking.html", "6-Selective-Pallet-Racking.html", "7-Narrow-Aisle-Pallet-Racking.html", "8-Pallet-Rack-Wire-Decking.html", "index.html"];
...
exports.default = function () {
  ...
  $(".js-input").each(function (index, element) {
    if ($(element).val() !== "") {
      $(element).parents(".js-parent-input").addClass('active');
    }
  });
  $(document).on('focus load', '.js-input', function () {
    $(this).parents(".js-parent-input").addClass('active');
  });
  $(document).on('blur', '.js-input', function () {
    if ($(this).val() == '') {
      $(this).parents(".js-parent-input").removeClass('active');
    }
  });

  if ($('.js-top-section').length) {
