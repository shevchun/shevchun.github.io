...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.text-content > table').wrap('<div class="table-scroll"></div>');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('.js-active-form').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.testimonials-page__box').toggleClass('active-review-form');
    if (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() > 1200) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('.active-review-form').length && jquery__WEBPACK_IMPORTED_MODULE_0__('html, body').animate({
        scrollTop: 0
      }, 500);
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__('.star-rating__item').on('click', function rateClick() {
    var parent = jquery__WEBPACK_IMPORTED_MODULE_0__(this).parent('.star-rating');
    var rating = jquery__WEBPACK_IMPORTED_MODULE_0__(this).data('value');
    var valueHolder = parent.find('.star-rating__value');
    if (!parent.hasClass('disabled')) {
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).addClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).prevAll('.star-rating__item').addClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).nextAll('.star-rating__item').removeClass('active');
      valueHolder.val(rating).change();
      valueHolder.attr('value', rating);
    }
  });
  var copyContent = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(codeVal) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return navigator.clipboard.writeText(codeVal);
            case 3:
              alert('Code copied');
              _context.next = 9;
              break;
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('.js-copy-code-btn').on('click', function copy() {
    var codeVal = jquery__WEBPACK_IMPORTED_MODULE_0__(this).siblings('.js-copy-code').attr('data-code');
    copyContent(codeVal);
  });
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('.holder__aside-sticky, .js-sticky').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.wrapper').addClass('wrapper--no-ovh');
  }
  if (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() < 1200) {
    if (jquery__WEBPACK_IMPORTED_MODULE_0__('.bonuses__item').length) {
      jquery__WEBPACK_IMPORTED_MODULE_0__('.bonuses__item').each(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('.menu-item-has-children > a, .menu-item-has-children > span').on('click', function mobileMenu() {
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).parents('.menu-item-has-children').toggleClass('active');
      return false;
    });
  }
  jquery__WEBPACK_IMPORTED_MODULE_0__('.questions__head').on('click', function questionsFunc() {
    jquery__WEBPACK_IMPORTED_MODULE_0__(this).parents('.questions__item').toggleClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0__(this).siblings('.questions__item-body').slideToggle();
  });
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('.online-slots__slider').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.online-slots__slider').slick({
      slidesToShow: 3,
      rows: 2,
      infinite: false,
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('.testimonials__slider').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.testimonials__slider').slick({
      slidesToShow: 3,
      arrows: false,
      infinite: true,
      swipeToSlide: true,
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('.first-screen__slider').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.first-screen__slider').slick({
      slidesToShow: 1,
      arrows: false,
      fade: true,
      asNavFor: '.first-screen__nav-slider'
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__('.first-screen__nav-slider').slick({
      slidesToShow: 5,
      arrows: false,
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__('.providers__slider').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.providers__slider').slick({
      slidesToShow: 1,
      arrows: false,
      infinite: false,
      fade: true,
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('.providers__nav').slick({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (["dev", "404.html", "Cricket-Betting-in-Singapore.html", "NBA-Betting.html", "Online-Baccarat-Singapore.html", "Online-Blackjack-Singapore.html", "Online-Horse-Betting-Singapore.html", "Online-Poker.html", "Online-Tennis-Betting-Singapore.html", "QQBet-and-CMDBET.html", "QQBet-and-Evolution-Gaming.html", "QQBet-and-M8bet.html", "QQBet-and-MAXBET.html", "QQBet-and-SA-Gaming.html", "QQBet-and-TBSbet.html", "QQBet-and-WinningFT.html", "blog-category.html", "blog-post.html", "blog.html", "casino-bonuses.html", "contacts.html", "eSports-betting.html", "football-betting.html", "index.html", "instant-withdrawal.html", "mobile-casino.html", "online-casino.html", "online-slots.html", "sbobet-provider.html", "testimonials.html"]);
...
jquery__WEBPACK_IMPORTED_MODULE_1__(window).on('load resize', function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_1__(window).width() < 1200) {
    jquery__WEBPACK_IMPORTED_MODULE_1__('.header__mobile').append(jquery__WEBPACK_IMPORTED_MODULE_1__('.header__nav'));
    jquery__WEBPACK_IMPORTED_MODULE_1__('.header__mobile').append(jquery__WEBPACK_IMPORTED_MODULE_1__('.header__top-right'));
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_1__('.header__bottom').append(jquery__WEBPACK_IMPORTED_MODULE_1__('.header__nav'));
    jquery__WEBPACK_IMPORTED_MODULE_1__('.header__top-right').insertAfter(jquery__WEBPACK_IMPORTED_MODULE_1__('.header__top-left'));
  }
});
